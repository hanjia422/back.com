...
<script type="text/javascript" src="<?php echo JS_URL;?>transport.js"></script><script type="text/javascript" src="js/common.js"></script><script language="JavaScript">
<!--
// 这里把JS用到的所有语言都赋值到这里
...
<script type="text/javascript" src="<?php echo JS_URL;?>utils.js"></script><script type="Text/Javascript" language="JavaScript">
<!--
onload = function()
{
  /* 检查订单 */
...
<div id="footer">
共执行 29 个查询，用时 0.087329 秒，Gzip 已禁用，内存占用 2.074 MB<br />
...
<!--
<embed src="<?php echo IMG_URL;?>online.wav" width="0" height="0" autostart="false" name="msgBeep" id="msgBeep" enablejavascript="true"/>
-->
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://active.macromedia.com/flash2/cabs/swflash.cab#version=4,0,0,0" id="msgBeep" width="1" height="1">
  <param name="movie" value="<?php echo IMG_URL;?>online.swf">
  <param name="quality" value="high">
  <embed src="<?php echo IMG_URL;?>online.swf" name="msgBeep" id="msgBeep" quality="high" width="0" height="0" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?p1_prod_version=shockwaveflash">
  </embed>
</object>
...
function showTodoList(adminid)
{
  if(!MyTodolist)
  {
    var global = $import("<?php echo JS_URL;?>global.js","js");
